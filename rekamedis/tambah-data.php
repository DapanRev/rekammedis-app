...
if ($msg == 'added') {
  ...
  <strong><i class="bi bi-check-circle-fill align-top me-2"></i>Tambah Data Rekam Medis Berhasil !</strong>
...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="<?= $main_url ?>rekamedis" class="text-decoration-none"><i class="bi bi-arrow-left align-top me-1"></i>Kembali</a>
      </div>
          ...
          <?php if ($msg !== '') {
            ...
            <div class="col-lg-6 pe-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="keluhan" id="keluhan" class="form-control border-0" placeholder="keluhan pasien tentang penyakitnya"></textarea>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="dokter" id="dokter" class="form-select">
                      ...
                      while ($data = mysqli_fetch_assoc($queryDokter)) { ?>
                          <option value="<?= $data['user_id'] ?>"><?= $data['fullname'] ?></option>
                      <?php } ?>
                    </select>
                </div>
                <div class="form-group mb-3">
                    <label for="diagnosa" class="form-label">Diagnosa</label>
                    <textarea name="diagnosa" id="diagnosa" class="form-control border-0" placeholder="hasil diagnosa dokter"></textarea>
                </div>
                <div class="form-group mb-3">
