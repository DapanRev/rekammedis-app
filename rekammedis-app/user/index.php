...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      ...
      <a href="<?= $main_url ?>user/tambah-user.php" class="btn btn-outline-secondary btn-sm mb-3" title="tambah user baru">
        <i class="bi bi-person-plus-fill align-top"></i>User Baru</a>
        ...
        <table class="table table-responsive table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $user['alamat']?></td>
                    <td>
                        <a href="edit-user.php?id=<?= $user['user_id'] ?>&gambar=<?= $user['gambar'] ?>" class="btn btn-sm btn-outline-warning" title="edit user"><i class="bi bi-pencil-square align-top"></i></a>
