...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      ...
      <a href="<?= $main_url ?>pasien/tambah-pasien.php" class="btn btn-outline-secondary btn-sm mb-3" title="tambah pasien baru">
        <i class="bi bi-person-plus-fill align-top "></i>Tambah Pasien</a>
        ...
        <table class="table table-responsive table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $pasien['alamat']?></td>
                    <td>
                        <a href="edit-pasien.php?id=<?= $pasien['id'] ?>" class="btn btn-sm btn-outline-warning" title="edit pasien"><i class="bi bi-pencil-square align-top"></i></a>
