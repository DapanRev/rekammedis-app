...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data Pasien Baru</h1>
        <a href="<?= $main_url ?>pasien" class="text-decoration-none"><i class="bi bi-arrow-left align-top me-1"></i>Kembali</a>
      </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" name="telpon" class="form-control" id="telpon" placeholder="Nomor Telepon Pasien" pattern="[0-9]{8,}" title="minimal 8 angka" required>
                </div>
                <div class="form-group mb-3">
