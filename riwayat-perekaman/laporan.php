...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <th class ="label-head">Nomor Telepon</th>
    ...
    <table>
        ...
        <tbody>';
            $sqlrm = "SELECT * FROM tbl_rekammedis INNER JOIN tbl_user ON 
            tbl_rekammedis.id_dokter = tbl_user.user_id WHERE id_pasien = '$id'";
