        ...
        <div class="row">
            <div class="col-lg-4 mb-4 text-center">
                <div class="px-4 mb-4">
                    ...
                    <img src="<?= $main_url ?>assets/gambar/<?= $user['gambar'] ?>" alt="user" class="img-thumbnail mb-3 rounded-circle tampil" width="120px">
            ...
            <div class="form-group mb-3">
                    ...
                    <input type="text" name="fullname" class="form-control" id="fullname" value="<?= $user['fullname'] ?>" placeholder="masukkan nama lengkap " required>
            </div>
            <div class="form-group mb-3">
                    ...
                    <select name="jabatan" id="jabatan" class="form-select" required>
                        ...
                        <option value="2" <?= $user['jabatan'] == 2 ? 'selected' : '' ?>>Dokter</option>
                        <option value="3" <?= $user['jabatan'] == 3 ? 'selected' : '' ?>>Admin</option>
                    </select>
            </div>
            <div class="form-group mb-3">
